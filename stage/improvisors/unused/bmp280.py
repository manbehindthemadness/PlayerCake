...
class ReadAlt:
    """
    Reads the altitude and temp information from the bmp 280 chip.
    """
    def __init__(self):
        # Get I2C bus
    ...
    def getvalues(self):
        """
        An attempt to get usable altitude data...
        """
        # BMP280 address, 0x77
        ...
        #					Normal mode
        self.bus.write_byte_data(0x77, 0xF4, 0x27)
        # BMP280 address, 0x77(118)
        # Select Configuration register, 0xF5(245)
        #		0xA0(00)	Stand_by time = 1000 ms
        self.bus.write_byte_data(0x77, 0xF5, 0xA0)
